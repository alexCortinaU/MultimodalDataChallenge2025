...
def test_model(session_name, output_csv_path):
    ...
    model = DinoV2Lit.load_from_checkpoint('./checkpoints/last-v1.ckpt',
...
if __name__ == "__main__":
    ...
    test_model(session_name='baseline_vit_v1_last', output_csv_path='vit_v1.csv') # pretrained vit on df